...
interface OnlyCheckPopupProps {
  ...
  onConfirm: (CheckList: CheckList) => void;
  onCancel: () => void;

}

export default function OnlyCheckPopup({ goalName, onConfirm, onCancel }: OnlyCheckPopupProps) {
...
const handleRegister = () => {
    ...
    onConfirm([{ checkListName: trimmed, clear: false }]);
